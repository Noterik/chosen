...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.set_default_values = function() {
      ...
      this.show_checkboxes = this.options.show_checkboxes || false;
      return this.allow_dropdown_item_deselect = this.options.allow_dropdown_item_deselect || false;
    };
    ...
    AbstractChosen.prototype.result_add_option = function(option) {
      var checkbox_el, classes, option_contents, option_contents_label, option_el;
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.search_results_mouseup = function(evt) {
      var $evtTarget, choice, index, parent, target;
      $evtTarget = $(evt.target);
      target = $evtTarget.hasClass("active-result") ? $evtTarget : $evtTarget.parents(".active-result").first();
      if (target.length) {
        this.result_highlight = target;
        this.result_select(evt);
        return this.search_field.focus();
      } else if (this.allow_dropdown_item_deselect) {
        parent = this.show_checkboxes ? $evtTarget.parent().parent() : $evtTarget.parent();
        index = parent.data('option-array-index');
        choice = this.container.find('.chosen-choices a[data-option-array-index="' + index + '"]');
        return this.choice_destroy(choice);
      }
    };
    ...
    Chosen.prototype.choice_destroy = function(link) {
      if (this.result_deselect(link[0].getAttribute("data-option-array-index"))) {
        ...
        if (this.is_multiple && this.choices_count() > 0 && this.get_search_field_value().length < 1 && this.hide_results_on_select) {
          this.results_hide();
        }
    ...
    Chosen.prototype.result_select = function(evt) {
      ...
      if (this.result_highlight) {
        ...
        if (this.show_checkboxes && !$(evt.target).is(':checkbox')) {
